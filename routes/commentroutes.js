...
router.post("/comments", (req, res, next) => {
  userComments
    ...
    .then(response => {
      Post.findByIdAndUpdate(req.body.post._id, {
...
router.put("/comments/:id", (req, res, next) => {
  ...
  userComments
    ...
    .then(() => {
      res.json({
        message: `Comment with ${req.params.id} is updated successfully.`
      });
    })
    .catch(err => {
      res.json(err);
...
router.delete("/comments/:id", (req, res, next) => {
  ...
  userComments
    ...
    .then(() => {
      res.json({
        message: `Comment with ${req.params.id} is removed successfully.`
      });
    })
    .catch(err => {
      res.json(err);
